...
class DownLoadModelImp : DownLoadModel {
    override fun startTorrentTask(bt: com.dream.tlj.mvp.e.DownloadTaskEntity): Boolean {
    ...
    override fun startTorrentTask(bt: com.dream.tlj.mvp.e.DownloadTaskEntity, indexs: IntArray): Boolean {
    ...
    override fun startUrlTask(url: String): Boolean {
        val task = com.dream.tlj.mvp.e.DownloadTaskEntity()
    ...
    override fun startTask(task: com.dream.tlj.mvp.e.DownloadTaskEntity): Boolean {
        try {
            var taskId: Long = 0
    ...
    override fun stopTask(task: com.dream.tlj.mvp.e.DownloadTaskEntity): Boolean {
        try {
    ...
    override fun deleTask(task: com.dream.tlj.mvp.e.DownloadTaskEntity, deleFile: Boolean): Boolean {
        try {
    ...
    override fun deleTask(task: com.dream.tlj.mvp.e.DownloadTaskEntity, stopTask: Boolean, deleFile: Boolean): Boolean {
        if (stopTask) {
            XLTaskHelper.instance(x.app().applicationContext).stopTask(task.taskId)
        }
    ...
    override fun getTorrentInfo(bt: com.dream.tlj.mvp.e.DownloadTaskEntity): List<TorrentInfoEntity> {
        val path = bt.localPath + File.separator + bt.getmFileName()
