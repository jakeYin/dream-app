...
class SourceListAdapter(private val context: Context, private val sourceView: SourceView, private val list: List<com.dream.tlj.mvp.e.MagnetInfo>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
